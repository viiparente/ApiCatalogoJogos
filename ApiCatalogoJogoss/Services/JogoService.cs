using ApiCatalogoJogoss.Entities;
using ApiCatalogoJogoss.Exceptions;
using ApiCatalogoJogoss.InputModel;
using ApiCatalogoJogoss.Repositories;
using ApiCatalogoJogoss.ViewModel;
...
namespace ApiCatalogoJogoss.Services
{
